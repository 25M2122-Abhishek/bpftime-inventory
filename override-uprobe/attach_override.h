...
// parses the ELF of ./victim to find the file offset of target_func.
					 ...
					 const char *name, int type)
{
	...
	/* Create a perf_event configured for an uprobe override */
	int res =
	...
	/* Attach a BPF program to that perf event */
